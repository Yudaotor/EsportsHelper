...
i18n = {"WebDriver generation failure!\nThe latest version of Google Chrome is not found.\nPlease check if Chrome downloaded or has the latest version.\nYou can also try to launch the program as an administrator.\nExit the program by pressing any key...": "1",
        ...
        "Incorrect proxy configuration. The default setting has been restored.": "1",
        "Incorrect UserDataDirectory path configuration. The default setting has been restored.": "1",
        "Incorrect language configuration. The default language zh_CN has been restored.": "1",
        "Watch system operational. Drops available.": "1",
        "Watch system work anomaly. Retrying...": "1",
        "Watch system work anomaly.": "1",
        "Drops check failed.": "1",
        "Drop alert failed.": "1",
        "Network error. Cannot open LolEsports website.": "1",
        "Logging in...": "1",
        "Account credentials sent successfully.": "1",
        "Network error. Login timeout.": "1",
        "Please enter 2FA code:": "1",
        "2FA code submitted successfully.": "1",
        "Authentication failure. Please log in manually using browser and try again.": "1",
        "Failed to check drop count.": "1",
        "Checking...": "1",
        "Session drops:": "1",
        "Lifetime drops:": "1",
        "No live broadcasts.": "1",
        "The match is currently live.": "1",
        "During the sleep period, the check interval is 1 hour.": "1",
        "Next check in:": "1",
        "Time left until the program will auto-close:": "1",
        "The corresponding window cannot be found.": "1",
        "An error has occurred.": "1",
        "Failed to get live broadcasts list.": "1",
        "Broadcast ended.": "1",
        "An error occurred while closing finished broadcast.": "1",
        " match skipped.": "1",
        "Failed to close Twitch stream.": "1",
        "Twitch stream resolution successfully set to 160p.": "1",
        "Twitch stream closed successfully.": "1",
        "Failed to set Twitch stream resolution.": "1",
        "Unable to set Twitch stream resolution.": "1",
        "Failed to close YouTube stream.": "1",
        "YouTube stream closed successfully.": "1",
        "YouTube stream resolution successfully set to 144p.": "1",
        "Failed to set YouTube stream resolution.": "1",
        "Unable to set YouTube stream resolution.": "1",
        "Time of the next broadcast:": "1",
        "Failed to get next broadcast time.": "1",
        "Failed to get drops count.": "1",
        "Details of this session drops:": "1",
        "Failed to count drops.": "1",
        "Failed to initialize drop count.": "1",
        "Hey, something is wrong.": "1",
        "Error alert sent successfully.": "1",
        "Failed to send error alert.": "1",
        "Exception error alert successful.": "1",
        "Exception error alert failed.": "1",
        "Failed to import override file.": "1",
        "Preparing...": "1",
        "Unsupported OS.": "1",
        }
