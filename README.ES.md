...
Luego deberás acceder a https://IP-DEL-HOST:6080/vnc.html y ejecutar el script "START" que se encuentra en el escritorio. Recuerda que deberás completar el captcha manualmente al momento de ingresar el usuario en el sitio web de Lolesports.
